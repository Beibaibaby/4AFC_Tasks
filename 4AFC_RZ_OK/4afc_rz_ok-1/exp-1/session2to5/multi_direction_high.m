...
subject_initials    ='OK_high';
block               = 0;  % 0 means test,run 10 blocks total


params_name = strcat(subject_initials,'.mat');
load( params_name ); % params file should have duration_list.
duration_list = double(duration_list);
