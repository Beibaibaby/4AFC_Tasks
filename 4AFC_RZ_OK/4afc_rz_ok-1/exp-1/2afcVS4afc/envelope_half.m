function [profile,mv_length] = envelope_half(time_sigma,frame_rate,cut_off,amplitude)
%%%

time_sigma = 2*time_sigma*1000;
if cut_off
    gauss_only = 0;
else
    gauss_only = 1;
...
mv_length = ceil(mv_length/2);
profile = profile( 1:mv_length );
