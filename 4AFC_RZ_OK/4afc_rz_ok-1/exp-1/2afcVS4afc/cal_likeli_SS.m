...
for i = 1:length(sizes)
    ...
    elseif length(params) == 5
        ...
        log_likeli_duration(i) = cal_likeli_duration( doi, curr_mu, params(5), n_alternatives);
    end
...
function log_likeli = cal_likeli_duration( data, mu, sigma, n_alternatives )
...
mu = log(mu);
if n_alternatives == 2
    correct_or_not = data(:,end-1);
else
    correct_or_not = data(:,end);
end
